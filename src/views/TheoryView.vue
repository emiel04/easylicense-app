  ...
  <main>
    ...
    <section>
      <div class="flex gap-3 pb-4">
        ...
        <RouterLink v-if="isAdmin" class="btn btn-primary" to="/editor/new">{{
            $t('add-new-lesson').capitalize()
          }}
        </RouterLink>
      ...
      <div class="pb-6 lessons">
        <RouterLink :to="`/theory/${lesson.id}`" v-for="lesson in lessons"
                    class="card w-fit bg-base-100 border-2 overflow-hidden hover:shadow-xl transition-all duration-300">
          <article>
